...
class ImageSliderGrid(LucidApp):
	def __init__(self, cache_path=defines.base_path+'cache/', fullscreen=False, resolution=(500, 400), 
					icon_path=defines.base_path+'icons/image_slider.png', base_graphics='pygame'):
